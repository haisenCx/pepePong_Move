module pong_addr::pepepong {
	...
	///Token Errors
    const THE_ACCOUNT_HAS_BEEN_REGISTERED : u64 = 5;
    const INVALID_TOKEN_OWNER : u64 = 6;
    const THE_ACCOUNT_IS_NOT_REGISTERED : u64 = 7;
    const INSUFFICIENT_BALANCE : u64 = 8;
    const ECOIN_INFO_ALREADY_PUBLISHED : u64 = 9;
    const EXCEEDING_THE_TOTAL_SUPPLY : u64 = 10;
	const MAX_MINTS_REACHED : u64 = 11;
	const MINT_GAP_NOT_REACHED : u64 = 12;
